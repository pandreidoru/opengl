...
void Shader::Compile(char const* vertex_code, char const* fragment_code) {
  ...
  uniform_ambient_colour = glGetUniformLocation(id_, "directional_light.colour");
  uniform_ambient_intensity = glGetUniformLocation(id_, "directional_light.ambient_intensity");
  uniform_direction = glGetUniformLocation(id_, "directional_light.direction");
  uniform_diffuse_intensity = glGetUniformLocation(id_, "directional_light.diffuse_intensity");
}
