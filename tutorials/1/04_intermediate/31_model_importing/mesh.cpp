...
void Mesh::CreateMesh(GLfloat* vertices, unsigned int* indices, unsigned int vert_num, unsigned int indices_num) {
  ...
  glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, vert_size * 8, nullptr);
  glEnableVertexAttribArray(0);

  // Texture coordinates
  glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, vert_size * 8, (void*)(vert_size * 3));
  glEnableVertexAttribArray(1);

  // Normal coordinates
  glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, vert_size * 8, (void*)(vert_size * 5));
